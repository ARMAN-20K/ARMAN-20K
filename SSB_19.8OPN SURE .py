...
\033[1;37m    ######      ######     ########  
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            ARMAN-20K
\033[1;37m Facebook:            MD ARMAN ALI ADOR 
\033[1;37m Github  :            ARMAN-20K/CYBER-404
...
def sarfraz():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://www.facebook.com/profile.php?id=100030027114066&mibextid=ZbWKwL')
    else:
        print('\n Select valid option ... ')
        time.sleep(2)
        SSB(allkey)
